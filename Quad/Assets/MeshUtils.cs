...
public static class MeshUtils
{
    ...
    new Vector2(0.1875f, 0.9375f), new Vector2(0.25f, 0.9375f),
       ...
       /* DIRT */ {
    new Vector2(0.125f, 0.8375f), new Vector2(0.1875f, 0.9375f),
 ...
 /* STONE  */{
    new Vector2(0, 0.875f), new Vector2(0.0625f, 0.875f),
                    new Vector2(0, 0.9375f),  new Vector2(0.9375f, 0.1875f)},
 /* SAND */  {
    ...
    public static Mesh MergeMeshes(Mesh[] meshes)
{
    ...
    {  // each mesh
        ...
        for (int j = 0; j < meshes[i].vertices.Length; j++) // vertices within each mesh
        {
            ...
            {
                pointsOrder.Add(p, pIndex);   // keeps track of vertices we've seen.
                pointsHash.Add(p);
                pIndex++;
            }
        }
